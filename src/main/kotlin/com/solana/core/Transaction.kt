...
class Transaction {
    ...
    fun compileMessage(): Message {
        ...
        if (instructions.isEmpty()) {
            throw TransactionException("No instructions provided")
        }
        ...
        for (signature in signatures) {
            ...
            if (uniqueIndex > -1) {
                ...
                throw TransactionException("unknown signer: ${signature.publicKey}")
            }
        }
    ...
    fun serialize(config: SerializeConfig = SerializeConfig()): ByteArray {
        ...
        if (config.verifySignatures &&
            ...
            throw TransactionException("Signature verification failed")
        }
    ...
    companion object {
        ...
        fun from(buffer: ByteArray): Transaction {
            ...
            for (i in 0..<signatureCount.first) {
                val signature = byteArray.slice(0..<SIGNATURE_LENGTH)
